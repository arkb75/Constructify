<template>
  <div class="container">
    ...
    <div class="content">
      <div class="question">
        <h2 style="color: red;">Red means firm only does architecture.</h2><br><br>
        <h2 style="color:gold;">Yellow means firm does interior designing as well.</h2><br><br>
        <h2 style="color: green;">Green means firm does project consulting/monitoring as well.</h2>
      </div>
    </div>
    <StepperComponent :steps="items" :activeTab="1" />
  </div>
</template>
