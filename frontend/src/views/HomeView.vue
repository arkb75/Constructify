...
<template>
  ...
  <body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
    ...
    <section class="pb_section bg-light pb_slant-white pb_pb-250" id="section-features">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md- col-sm-6">
            <div class="media d-block pb_feature-v1 text-left">
              <div class="pb_icon"><i class="ion-ios-cloud-outline pb_icon-gradient"></i></div>
              <div class="media-body">
                <h5 class="mt-0 mb-3 heading">Reduced Stress</h5>
                <p class="text-sans-serif">Focus on the excitement of building your dream home, not the headaches.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md- col-sm-6">
            <div class="media d-block pb_feature-v1 text-left">
              ...
              <div class="media-body">
                <h5 class="mt-0 mb-3 heading">Saved Time</h5>
                <p class="text-sans-serif">Spend less time chasing contractors and more time making decisions.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md- col-sm-6">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md">
            <div class="pb_pricing_v1 p-5 border text-center bg-white">
              <h3>Full <br>Support</h3>
              <!-- <span class="price"><sup>$</sup>99<span>month</span></span> -->
              <p class="pb_font-15">From finding your dream lot to moving in, we guide you every step of the way.</p>
              <p class="mb-0"><a href="#" role="button" class="btn btn-primary">Visualize Your Journey</a></p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg">
                ...
                <div class="media pb_feature-v2 text-left mb-1 mt-5">
                  ...
                  <div class="media-body">
                    ...
                    <p class="text-sans-serif pb_font-16">Far far away, behind the word mountains, far from the
    ...
    <section class="pb_section pb_slant-light pb_pb-220" id="section-testimonials">
      <div class="container">
              ...
              <div class="pb_slider_content js-pb_slider_content2">
                <div>
                  <div class="media d-block text-center testimonial_v1 pb_quote_v2">
                    <div class="media-body">
                      ...
                      <blockquote class="mb-5">Far far away, behind the word mountains, far from the countries Vokalia
                      ...
                      <h3 class="heading">Adil Altaf</h3>
                      <span class="subheading">@arkdil.a02</span>
                ...
                <div>
                  <div class="media d-block text-center testimonial_v1 pb_quote_v2">
                    <div class="media-body">
                      <div class="quote">&ldquo;</div>
                      <blockquote class="mb-5">The Big Oxmox advised her not to do so, because there were thousands of
    ...
    <section class="pb_xl_py_cover overflow-hidden pb_slant-light pb_gradient_v1 cover-bg-opacity-8 bgimgissue">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-5 justify-content-center">
            <h2 class="heading mb-5 pb_font-40">Build with Confidence. Get Started Today! </h2>
            <div class="sub-heading">
              <p class="mb-4">Takes less than 2 minutes to sign up and is absolutely free!</p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col text-center">
            <p class="pb_font-14">&copy; 2024. All Rights Reserved. <br> </p>
          </div>
        </div>
      </div>
    </footer>
